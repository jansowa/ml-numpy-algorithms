...
class TestLinearRegression(unittest.TestCase):
    ...
    def test_calculate_beta(self):
        ...
        X = np.array([[3], [2]])
        y = np.array([7, 5])
        np.testing.assert_array_almost_equal(LinearRegression._calculate_beta(X, y), [1, 2])
    ...
    def test_calculate_beta3(self):
        ...
        X = np.array([[1, 1],
                      ...
                      [2, 1]])
        y = np.array([4, 5, 5])
        np.testing.assert_array_almost_equal(LinearRegression._calculate_beta(X, y), [1, 1, 2])
    ...
    def test_calculate_targets(self):
        ...
        X = np.array([[1, 1],
                      ...
                      [2, 1]])
        beta = np.array([1, 1, 2])
        np.testing.assert_array_almost_equal(LinearRegression._calculate_targets(X, beta), [4, 5, 5])
    ...
    def test_calculate_targets2(self):
        ...
        X = np.array([[1, 1],
                      ...
                      [5, 5]])
        beta = np.array([1, 1, 2])
        np.testing.assert_array_almost_equal(LinearRegression._calculate_targets(X, beta), [4, 5, 5, 16])
